...
public class ReviewController {
    ...
    public HttpEntity<ResourceSupport> root() {
        ...
        resourceRoot.add(
                new Link(
                        new UriTemplate(
                                linkTo(ReviewController.class, "").slash("reviews").toString()
                                        + "{?eventId}"), "reviews"));
        resourceRoot.add(
                new Link(
                        new UriTemplate(
    ...
    public HttpEntity<HALReview> review(@PathVariable String id) {
        ...
        review.add(
                linkTo(
                        methodOn(ReviewController.class).review(id)).withRel("self"));
    ...
    public HttpEntity<HALReviews> reviews(@RequestParam(value = "eventId") String eventId) {
        ...
        halReviews.add(
                linkTo(
                        methodOn(ReviewController.class).reviews(eventId)).withRel("self"));
