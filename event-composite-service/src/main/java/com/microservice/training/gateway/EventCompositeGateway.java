...
public class EventCompositeGateway {
    ...
    public Event getEvent(String eventId) {
        return parseEvent(
                restTemplate.getForEntity(
                        loadBalancer.choose("EVENT").getUri() + "/events/" + eventId, String.class));
    }
    ...
    public List getRecommendations(String eventId) {
        ...
        try
        {
            resultStr = restTemplate.getForEntity(
                    loadBalancer.choose("RECOMMENDATION").getUri() + "/recommendations?eventId=" + eventId, String.class);
        }
        catch (Exception e){}
        if (null != resultStr){
    ...
    public List getReviews(String eventId) {
        ...
        {
            resultStr = restTemplate.getForEntity(
                    loadBalancer.choose("REVIEW").getUri() + "/reviews?eventId=" + eventId, String.class);
        }
        catch (Exception e){}
        if (null != resultStr){
